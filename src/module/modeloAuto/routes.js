...
async function getById(req, res) {
    ...
    try {
        ...
        if (modeloAutoYProductosConImagenes.length > 0) {
            ...
            // No se encontraron productos relacionados con el modelo de auto
            res.status(500).json({ error: true, message: 'No se encontraron datos para el modelo de auto especificado' });
        }
    } catch (error) {
